...
<div class="row">
    ...
    <div class="col-12 mt-2">
        ...
        <input type="text" readonly placeholder="Ticket" name="ticket" id="ticket"
            class="form-control dark form-control-sm shadown-sm @error('ticket') is-invalid   @enderror"
    ...
    <div class="col-12 mt-2">
        ...
        <select name="id_mesa" id="id_mesa"
            class="form-control dark form-control-sm shadown-sm selectMesa @error('id_mesa') is-invalid   @enderror">
    ...
    <div class="col-12 row p-0 m-0 mt-2">
        ...
        <div class="col-4 p-0">
            <input type="number" style="font-size:18px" onkeyup="calcularVenta()" placeholder="Cantidad"
                ...
                class="form-control dark m-0 h-100 text-center form-control-sm shadown-sm @error('cantidad') is-invalid   @enderror"
    ...
    <div class="col-12 mt-2">
        ...
        <input type="number" onkeyup="calculoproducto()" placeholder="Precio" name="precio" id="precio"
            class="form-control dark form-control-sm shadown-sm @error('precio') is-invalid   @enderror" step="0.01"
    ...
    <div class="col-12 row m-0 p-0">
        <div class="col-6 mt-2 pe-0">
            ...
            <textarea name="observacion" placeholder="Observación" id="observacion" cols="30" rows="3"
                class="form-control dark form-control-sm shadown-sm @error('comentario') is-invalid   @enderror">{{ old('comentario', $venta->observacion) }}</textarea>
            @error('observacion')
                <span class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                </span>
